...
const Tab_49_rpt_PF_NetRecoveries = (requestParams) => {
  const query = knex().raw(
    ...
    current_year_recoveries_stob_no_param AS (
      SELECT
      current_year_recoveries_stob_base.project_id,
      ...
      SUM(current_year_recoveries_stob_base.q1_amount + current_year_recoveries_stob_base.q2_amount + current_year_recoveries_stob_base.q3_amount + current_year_recoveries_stob_base.q4_amount) AS current_fy_total_recoverable,
      SUM(CASE WHEN current_year_recoveries_stob_base.q1_recovered THEN current_year_recoveries_stob_base.q1_amount ELSE 0::money END + CASE WHEN current_year_recoveries_stob_base.q2_recovered THEN current_year_recoveries_stob_base.q2_amount ELSE 0::money END + CASE WHEN current_year_recoveries_stob_base.q3_recovered THEN current_year_recoveries_stob_base.q3_amount ELSE 0::money END + CASE WHEN current_year_recoveries_stob_base.q4_recovered THEN current_year_recoveries_stob_base.q4_amount ELSE 0::money END) AS current_fy_recovered_to_date,
    ...
    financial_recovery_by_portfolio_and_stob_recovered_no_param AS (
      ...
      SUM(current_year_recoveries_stob_no_param.current_fy_recovered_to_date) AS sum_of_current_fy_recovered_to_date
    FROM
      current_year_recoveries_stob_no_param
    GROUP BY
      current_year_recoveries_stob_no_param.project_id,
      current_year_recoveries_stob_no_param.portfolio_id,
      current_year_recoveries_stob_no_param.fiscal_year,
    ...
    -- Main Query
    SELECT
      SUM(current_year_recoveries_stob_no_param.current_fy_total_recoverable) AS sum_of_current_fy_total_recoverable1,
      current_year_recoveries_stob_no_param.project_id,
      ...
      SUM(current_year_recoveries_stob_no_param.current_fy_recovered_to_date) AS cy_recovered_to_date,
      SUM(current_year_recoveries_stob_no_param.current_fy_total_recoverable) AS cy_total_recoverable
    FROM
      financial_recovery_by_portfolio_and_stob_recovered_no_param
    ...
    GROUP BY
      ...
      current_year_recoveries_stob_no_param.fiscal_year,
      current_year_recoveries_stob_no_param.fiscal,
      financial_recovery_by_portfolio_and_stob_recovered_no_param.sum_of_current_fy_recovered_to_date,
