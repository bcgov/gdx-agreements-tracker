 ...
 * @returns {object}
 */
controller.Tab_4_rpt_CA_Capital_GDX = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_4_rpt_CA_Capital_GDX("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_4_rpt_CA_Capital_GDX.docx");
