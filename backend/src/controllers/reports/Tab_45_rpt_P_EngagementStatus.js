 ...
 * @returns {object}
 */
controller.Tab_45_rpt_P_EngagementStatus = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_45_rpt_P_EngagementStatus("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_45_rpt_P_EngagementStatus.docx");
