 ...
 * @returns {object}
 */
controller.Tab_47_rpt_PA_EngagementStatusSummary = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_47_rpt_PA_EngagementStatusSummary("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_47_rpt_PA_EngagementStatusSummary.docx");
