 ...
 * @returns {object}
 */
controller.Tab_43_rpt_PF_RecoveryForecast = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_43_rpt_PF_RecoveryForecast("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_43_rpt_PF_RecoveryForecast.docx");
