 ...
 * @returns {object}
 */
controller.Tab_38_rpt_PF_JVsforFiscal_Quarter = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_38_rpt_PF_JVsforFiscal_Quarter("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_38_rpt_PF_JVsforFiscal_Quarter.docx");
