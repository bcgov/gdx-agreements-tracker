 ...
 * @returns {object}
 */
controller.Tab_46_rpt_PA_EngagementExecutiveRollup = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_46_rpt_PA_EngagementExecutiveRollup("variableName2");
