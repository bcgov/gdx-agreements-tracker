 ...
 * @returns {object}
 */
controller.Tab_24_rpt_PA_Gantt = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_24_rpt_PA_Gantt("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_24_rpt_PA_Gantt.docx");
