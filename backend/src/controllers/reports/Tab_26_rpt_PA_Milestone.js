 ...
 * @returns {object}
 */
controller.Tab_26_rpt_PA_Milestone = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_26_rpt_PA_Milestone("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_26_rpt_PA_Milestone.docx");
