 ...
 * @returns {object}
 */
controller.Tab_12_rpt_CF_InvoicePaymentsbyPortfolio = async (request, reply) => {
  ...
  try {
    ...
    let variableName = await model.Tab_12_rpt_CF_InvoicePaymentsbyPortfolio("variableName2");
    ...
    const body = await getDocumentApiBody(result, "Tab_12_rpt_CF_InvoicePaymentsbyPortfolio.docx");
