...
const model = require("@models/contracts/invoice_deliverables");
const what = { single: "invoice deliverable", plural: "invoice deliverables" };
const controller = useController(model, what, "contracts");

/**
 * Gets all invoice deliverables belonging to the given invoice.
 *
...
/**
 * Add an invoice deliverable based on request body info.
 *
 * @param   {FastifyRequest} request FastifyRequest is an instance of the standard http or http2 request objects.
 * @param   {FastifyReply}   reply   FastifyReply is an instance of the standard http or http2 reply types.
 * @returns {object}
