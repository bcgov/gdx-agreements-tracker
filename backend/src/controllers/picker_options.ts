...
const Model = require("../models/picker_options.js");
...
const getAll = async (request, reply) => {
  if (userCan(request, "general_read_all")) {
    ...
    log.trace('user lacks capability "picker_options_read_all"');
...
const getOne = async (request, reply) => {
  if (userCan(request, "general_read_all")) {
    ...
    log.trace('user lacks capability "picker_options_read_all" || "picker_options_read_mine"');
    return notAllowed(reply);
  }
};
