...
export const AgreementSection = ({
  ...
  return (
    <>
      ...
      />
      <StyledBox>
        <TextDisplay title="Total Project Budget" value={query.data.data.total_project_budget} />
      </StyledBox>
      <StyledBox>
        <TextDisplay title="Recoverables Total" value={query.data.data.recoverable_amount} />
      </StyledBox>
      <Box>
